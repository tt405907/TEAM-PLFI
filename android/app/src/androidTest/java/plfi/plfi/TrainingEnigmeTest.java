...
public class TrainingEnigmeTest {
    ...
    public void envoiCarreTrainingEnigme() {
            ...
            TextView messageDuServeur = mainActivityRule.getActivity().message_Serveur_Enigme;
            String enigme = messageDuServeur.getText().toString();
            Forme formeAttendueParEnigme = mainActivityRule.getActivity().gameEnigme.getForme(enigme);

            System.out.println(formeAttendueParEnigme.toString());
    ...
    public void envoiRondTrainingEnigme() {
        ...
        mainActivityRule.getActivity().gamePrint.getPoints().clear();
